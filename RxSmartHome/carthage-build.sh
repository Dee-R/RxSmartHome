...
# reinstallation de carthage
# @ferologics you'll need to install this unreleased version of carthage first, but then yes, that section is how you'll build using xcframeworks.
# To test this exact PR, you can check out its branch and run make install.
# If you just want to test xcframework support, building from master is fine. You can do that using brew install --HEAD carthage.
################# utilisation : carthage update --use-xcframeworks